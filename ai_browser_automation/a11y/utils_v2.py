...
async def find_scrollable_element_ids(
    stagehand_page: 'AIBrowserAutomationPage',
    target_frame: Optional[Frame] = None
) -> Set[int]:
    """
...
async def resolve_frame_chain(
    ...
    Args:
        sp: The AIBrowserAutomationPage instance for evaluating XPath and locating frames
...
async def get_accessibility_tree_with_frames(
    ...
    Args:
        stagehand_page: The AIBrowserAutomationPage instance for Playwright and CDP interaction
