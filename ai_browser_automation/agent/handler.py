"""Agent handler for AIBrowserAutomationPage integration."""
...
if TYPE_CHECKING:
    from ..core.ai_browser_automation import AIBrowserAutomation
...
class AgentHandler:
    ...
    Integrates agent functionality with AIBrowserAutomationPage.
    """
    
    def __init__(
        self,
        ai_browser_automation: 'AIBrowserAutomation',
        ai_browser_automation_page: 'AIBrowserAutomationPage',
        ...
        # Create agent
        self.agent = AIBrowserAutomationAgent(self.agent_client, logger)
    ...
    async def _inject_cursor(self) -> None:
        ...
        try:
            ...
            CURSOR_ID = "ai_browser_automation-cursor"
            HIGHLIGHT_ID = "ai_browser_automation-highlight"
