...
(function(elements) {
    ...
    const existingOverlays = document.querySelectorAll('.ai-browser-automation-overlay');
    existingOverlays.forEach(el => el.remove());
    
    // Create style element if it doesn't exist
    let styleEl = document.getElementById('ai-browser-automation-styles');
    if (!styleEl) {
        styleEl = document.createElement('style');
        styleEl.id = 'ai-browser-automation-styles';
        styleEl.textContent = `
            .ai-browser-automation-overlay {
                position: absolute;
            ...
            .ai-browser-automation-overlay:hover {
                background: rgba(255, 0, 128, 0.3);
                border-color: #ff0080;
            }
            .ai-browser-automation-label {
                position: absolute;
                top: -20px;
                left: 0;
                background: #ff0080;
            ...
            .ai-browser-automation-scrollable {
                border-color: #00ff80 !important;
                background: rgba(0, 255, 128, 0.1) !important;
            }
            .ai-browser-automation-scrollable .ai-browser-automation-label {
                background: #00ff80;
                color: black;
            }
        `;
    ...
    elements.forEach((element, index) => {
        try {
            ...
            overlay.className = 'ai-browser-automation-overlay';
            if (element.isScrollable) {
                overlay.className += ' ai-browser-automation-scrollable';
            }
            ...
            label.className = 'ai-browser-automation-label';
    ...
    return document.querySelectorAll('.ai-browser-automation-overlay').length;
})(arguments[0]);
"""
...
(function() {
    const overlays = document.querySelectorAll('.ai-browser-automation-overlay');
    overlays.forEach(el => el.remove());
    
    const style = document.getElementById('ai-browser-automation-styles');
